        ...
        <div class="row g-2 align-items-center">
            <div class="col card">
                <div class="card-header">
                    <h5 class="card-title">Create Trainings</h5>
                </div>
                <form class="" method="post" action="{{url('admin/course/create-step2')}}" enctype="multipart/form-data" data-action="make_ajax_file">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <textarea name="topic_summary" id="topic_summary" class="form-control"></textarea>
                    ...
                    <div class="card-footer">
                        ...
                        <a  class="btn btn-danger" href="{{url('/admin/course/edit/'.request()->route('id'))}}">Back</a>
                        <a  class="btn btn-success" href="{{url('/admin/course/create-step3/'.request()->route('id'))}}">Proceed</a>
                    </div>
                </form>
            </div>
        </div>
