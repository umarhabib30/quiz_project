                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type='text' value="{{@$row['name']}}" name="name" id="name" class="form-control" required="" data-target="#slug" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Class Number</label>
                                        <input type='text' name="number" id="number" class="form-control" required="" value="{{@$row['number']}}"  />
                                    </div>
                                </div>
                             </div>
                         </div>
