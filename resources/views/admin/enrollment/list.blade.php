                        ...
                        <table class="table table-vcenter table-mobile-md card-table" data-url="{{$action}}/edit">
                            ...
                            <tbody>
                             ...
                             <tr class="list_{{$val[$module['db_key']]}}">
                                ...
                                <td class="pl-0" data-id="{{$val[$module['db_key']]}}">{{$val['student']['name']}}</td><!-- Display creator's name -->
                                @if(\Auth::user()->role == 1 || Auth()->user()->role == '0')
                                <td>
                                    <div class="btn-group dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{$action}}/edit/{{$val[$module['db_key']]}}">Edit Enrollment</a>
                                            <a class="dropdown-item" href="{{url($module['action'].'/delete/'.$val[$module['db_key']])}}">Delete Enrollment</a>
                                        </div>
                                    </div>
                                </td>
                                @endif
